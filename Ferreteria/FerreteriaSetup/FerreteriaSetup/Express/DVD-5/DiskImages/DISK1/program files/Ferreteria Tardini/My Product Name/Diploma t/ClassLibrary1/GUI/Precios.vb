...
Public Class Precios
    ...
    Private Sub Precios_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If Principal.CulturaGlobal = "ESPAÑOL" Then
            ...
            PreciosLabel.Text = RTrim(Multiidioma.ObtenerValue("PRECIOS", Cultura))
            MarcaRadioButton.Text = RTrim(Multiidioma.ObtenerValue("MARCA", Cultura))
            SubRadioButton.Text = RTrim(Multiidioma.ObtenerValue("SUBCATEGORIA", Cultura))
            CategoriaRadioButton.Text = RTrim(Multiidioma.ObtenerValue("CATEGORIA", Cultura))
            EXCLUIR.Text = RTrim(Multiidioma.ObtenerValue("EXCLUIR", Cultura))
            AceptarButton.Text = RTrim(Multiidioma.ObtenerValue("ACEPTAR", Cultura))
            AumentarRadioButton.Text = RTrim(Multiidioma.ObtenerValue("AUMENTAR", Cultura))
            DescontarRadioButon.Text = RTrim(Multiidioma.ObtenerValue("DESCONTAR", Cultura))
            CantidadArticulosLabel.Text = RTrim(Multiidioma.ObtenerValue("CANTIDADARTICULOS", Cultura))
